...
const visualSource =
  ...
  `import { resolveRuntimeStyleAssetPath } from '../assets/runtimeAssetPaths';\n\n` +
  ...
  `export const CENTRAL_HUB_ASSET_PATHS = CENTRAL_HUB_ASSETS.map((asset) => resolveRuntimeStyleAssetPath(asset.path));\n\n` +
...
console.log(
  [
    ...
    `Listed ${runtimeAssetRelativePaths.size} source-library assets for the tracked runtime export.`,
  ].join('\n'),
);
